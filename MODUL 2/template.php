...
if (isset($_POST['hitung'])) {
    ...
    $tb_konversi = $tinggi_badan / 100;
    $bmi = $berat_badan / ($tb_konversi ** 2);
    $status_input = true;
    // **********************  1  ************************** 
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    if ($status_input == true) {
                        if ($bmi <= 18.4) {
                            echo "Berat badan kamu tergolong Underweight";
                        } elseif ($bmi > 18.4 && $bmi <= 24.9) {
                            echo "Berat badan kamu tergolong Normal";
                        } elseif ($bmi > 24.9 && $bmi <= 39.9) {
                            echo "Berat badan kamu tergolong Overweight";
                        } elseif ($bmi > 39.9) {
                            echo "Berat badan kamu tergolong Obese";
                        }
                    } else {
                        echo "Inputan tidak boleh ada yang kosong";
                    }
                    ?>
