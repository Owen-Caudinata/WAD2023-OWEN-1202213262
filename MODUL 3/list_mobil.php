                    ...
                    if ($result == true) {
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="form_detail_mobil.php?id=<?= $row['id'] ?>" class="btn btn-info" role="button">Details</details></a>
                                </td>

                                <td>
                                    <a href="form_update_mobil.php?id=<?= $row['id'] ?>" class="btn btn-info" role="button">Update</details></a>
                                </td>
                            </tr>
