            ...
            <div class="col-lg-6">
                <div class="card px-5 py-5">
                    ...
                    <form method="post" action="../config/RegisterController.php">
                        ...
                        <input type="text" id="name" class="form-control mb-3" name="name" placeholder="Your Name"
                            required>
                        <label for="username" class="fw-bold">Username</label>
                        <input type="text" id="username" class="form-control mb-3" name="username"
                            placeholder="Your Username" required>
                        <label for="email" class="fw-bold">Email</label>
                        <input type="email" id="email" class="form-control mb-3" name="email" placeholder="Your Email"
                            required>
